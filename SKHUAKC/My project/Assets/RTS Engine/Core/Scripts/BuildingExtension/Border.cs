...
namespace RTSEngine.BuildingExtension
{
    public class Border : MonoBehaviour, IBorder
    {
        ...
        private GameObjectToBorderObjectInput borderPrefab = null;
        private IBorderObject currBorderObject = null; 
        ...
        public void Init(IGameManager gameMgr, IBuilding building)
        {
            ...
            {
                currBorderObject = buildingMgr.SpawnBorderObject(
                    borderPrefab.Output,
                    new BorderObjectSpawnInput(
                        border: this,
                        spawnRotation: borderPrefab.Output.transform.rotation));
            }
