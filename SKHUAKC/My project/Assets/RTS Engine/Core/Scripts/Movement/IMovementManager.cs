...
namespace RTSEngine.Movement
{
    public interface IMovementManager : IPreRunGameService
    {
        ...
        ErrorMessage SetPathDestination(IReadOnlyList<IEntity> entities, Vector3 destination, float offsetRadius, IEntity target, bool playerCommand);
        ErrorMessage SetPathDestinationLocal(IReadOnlyList<IEntity> entities, Vector3 destination, float offsetRadius, IEntity target, bool playerCommand);
