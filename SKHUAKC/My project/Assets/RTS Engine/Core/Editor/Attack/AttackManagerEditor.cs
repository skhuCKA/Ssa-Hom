...
namespace RTSEngine.EditorOnly.Attack
{
    ...
    public class AttackManagerEditor : TabsEditorBase<AttackManager>
    {
        ...
        {
            EditorGUILayout.PropertyField(SO.FindProperty("moveAttackEnabled"));
            EditorGUILayout.PropertyField(SO.FindProperty("moveAttackKey"));
            EditorGUILayout.PropertyField(SO.FindProperty("moveAttackTargetEffectPrefab"));
        }
    }
}
